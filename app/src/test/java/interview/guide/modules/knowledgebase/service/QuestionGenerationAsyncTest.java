...
import com.ywy.interviewagentapplication.modules.knowledgebase.listener.QuestionGenStreamConsumer;
...
class QuestionGenerationAsyncTest {
  ...
  class ConsumerExecution {
    ...
    void shouldResetToQueuedBeforeRetry() throws Exception {
      ...
      doThrow(new BusinessException(
          com.ywy.interviewagentapplication.common.exception.ErrorCode.INTERVIEW_QUESTION_GENERATION_FAILED,
          "模拟失败"))
          .when(failingService)
      ...
      invokeProcessMessage(consumer, Map.of(
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_KB_ID, "1",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_TASK_ID, "task-1",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_DIFFICULTY, "mid",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_QUESTION_COUNT, "5",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_FOLLOW_UP_COUNT, "2",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_CATEGORY_LIMIT, "3",
          com.ywy.interviewagentapplication.common.constant.AsyncTaskStreamConstants.FIELD_RETRY_COUNT, "0"
      ));
      ...
      assertThat(saved)
          .allSatisfy(question ->
              assertThat(question.getStatus()).isEqualTo(
                      com.ywy.interviewagentapplication.modules.knowledgebase.model.KnowledgeBaseQuestionStatus.DRAFT));
    }
  ...
  private void invokeProcessMessage(
    ...
    Method method = com.ywy.interviewagentapplication.common.async.AbstractStreamConsumer.class
